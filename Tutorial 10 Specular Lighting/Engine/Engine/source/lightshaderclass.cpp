...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
	XMMATRIX projectionMatrix, ID3D11ShaderResourceView* texture, XMFLOAT3 cameraPosition, XMFLOAT3 lightDirection, XMFLOAT4 specColor,XMFLOAT4 ambienteColor, XMFLOAT4 diffuseColor, float specularPower)
{
	bool result;


	// Set the shader parameters that it will use for rendering.
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, cameraPosition, lightDirection, specColor, ambienteColor, diffuseColor, specularPower);
	if(!result)
	{
		return false;
	}
											...
											XMFLOAT4 specColor, XMFLOAT4 ambienteColor,  XMFLOAT4 diffuseColor, float specularPower)
{
	...
	dataPtr2->ambienteSpecColor = specColor;
